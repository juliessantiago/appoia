<div>
    ...
    <div class="container flex justify-center"><!--alterar esse tamanho, só altera a div, não o tamanho da exibição da imagem--> 
       <img src="{{ $file->temporaryUrl() }}" class="w-1/2"><!--tamanho da imagem está muito grande! --> 
    </div>
   @endif
   <div wire:loading.delay.longer  wire:target="file" class="">
    ...
    <form wire:submit.prevent="save">
            ...
            @else
                <input class=""  type="file" wire:model="file">
            @endif
    </form>
</div>
