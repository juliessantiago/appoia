<div class="flex justify-center">
    <div class="max-w-screen-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-4">
        {{-- <a href="{{route('showVoluntario', [$voluntario->id])}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> --}}
          <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          <div class="flex flex-col justify-center items-center p-10 duration-300 transform hover:scale-110">
              ...
              <a href="https://8x8.vc/vpaas-magic-cookie-ce4ec617270641c8a072e2e3265ca160.{{$consultaAberta[0]->link}}" class="text-gray-800" target="_blank">Teste consulta</a>
