<div class="m-4">
    ...
    @else
        <p class="text-gray-400 text-center text-md">Desculpe, não encontramos voluntários que abordem esse assunto por enquanto</p>
    @endif
</div>
